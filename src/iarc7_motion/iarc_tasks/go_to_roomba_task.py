...
class GoToRoombaTask(object, AbstractTask):

    def __init__(self, task_request):

        self._roomba_id = task_request.frame_id  + '/base_link'
        # true means hit roomba, false means block
        self._ending_radius_to_roomba = task_request.ending_radius_to_roomba
    ...
    def get_desired_command(self):
        with self._lock:
            ...
            return (TaskAborted(msg='Illegal state reached in GoTo Roomba task'),)
    ...
    def _check_max_ending_roomba_range(self):
        ...
        return (_distance_to_roomba <= (self._ending_radius_to_roomba + self._overshoot))
